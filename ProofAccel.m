...
%   Версия: 3.0
%   Изменения:   
%   - Добавлены дополнительные параметры рассеяния
%   - Исправлены ошибки сравнения спектральной плотности энергии уровней
%   - Изменен алгортим расчёта угла инклинометра
%  Дата: 01.02.2017
