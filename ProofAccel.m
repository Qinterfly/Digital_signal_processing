...
%   Версия: 3.8
%   Изменения:   
%   - Дополнен режим сравнения выбранных сигналов
%   - Добавлена возможность задания границ построения поверхностей
%   - Добавлен идентификатор исходного файла в выходные данные
%  Дата: 14.10.2018
