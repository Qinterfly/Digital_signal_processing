...
%Осуществление спектрального преобразования (Фурье или Уэлча) и
%препроцессинг данных перед построением спектральной поверхности 
%Mode = FFT || Welch
...
% Приведение средней линии сигнала к нулю
for i = 1:LevelsNumb
    PartsSignalGlued{i}(:, 2) = PartsSignalGlued{i}(:, 2) - mean(PartsSignalGlued{i}(:, 2)); 
end
